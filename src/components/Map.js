    ...
    return (
        <>
            ...
            <map name='starmap' className='starmap'>
                ...
                ?
                <h5 className='starnav-beer'>Menu</h5>
                :
                <h5 id='star-nav-beer' className='starnav-beer'>Menu</h5>
                }

                <area shape='circle' coords={coordinates['Cocktails']} alt='Cocktails' href='#team' data-title='Cocktails' className='star' onClick={() => setToggleCocktailStar(true)} onMouseOver={ () => setToggleCocktailStar(true) } onMouseOut={ () => setToggleCocktailStar(false) } />
                { toggleCocktailStar === false
                ?
                <h5 className='starnav-cocktail'>Team</h5>
                :
                <h5 id='star-nav-cocktail' className='starnav-cocktail'>Team</h5>
                }

                <area shape='circle' coords={coordinates['Food']} alt='Food' href='#contact' data-title='Food' className='star' onClick={() => setToggleBeer(false)} onMouseOver={ () => setToggleFoodStar(true) } onMouseOut={ () => setToggleFoodStar(false) } />
                { toggleFoodStar === false
                ?
                <h5 className='starnav-food'>Contact</h5>
                :
                <h5 id='star-nav-food' className='starnav-food'>Contact</h5>
                }
