...
function BlackFox(props) {

    const previousPage = event => {
        props.history.goBack()
    }

    let beerName = props.beers[2].name
    let beerDescription = props.beers[2].description
    let beerAbv = props.beers[2].alcohol
    let beerStyle = props.beers[2].style
    let beerIbu = props.beers[2].ibu
